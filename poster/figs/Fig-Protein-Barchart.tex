...
% Brace and improvement
\draw[decorate, decoration={brace, amplitude=4pt, mirror}, thick, CornellRed!80!black]
    (\maxbar+0.3, \mone+\gap+2*\barh) -- (\maxbar+0.3, \mone-\gap-2*\barh);
...
% Brace and improvement
\draw[decorate, decoration={brace, amplitude=4pt, mirror}, thick, CornellRed!80!black]
    (\maxbar+0.3, \mtwo+\gap+2*\barh) -- (\maxbar+0.3, \mtwo-\gap-2*\barh);
...
% Brace and improvement
\draw[decorate, decoration={brace, amplitude=4pt, mirror}, thick, CornellRed!80!black]
    (\maxbar+0.3, \mthree+\gap+2*\barh) -- (\maxbar+0.3, \mthree-\gap-2*\barh);
