...
% VAE bar (bottom) - White with gray outline
...
% Improvement
\node[font=\small\bfseries, CornellRed!90!black, anchor=west] at (\chartx+\maxbar+0.6, \mone) {$6.9\times$};
...
\node[font=\small\bfseries, CornellRed!90!black, anchor=west] at (\chartx+\maxbar+0.6, \mtwo) {$3.4\times$};
...
\node[font=\small\bfseries, CornellRed!90!black, anchor=west] at (\chartx+\maxbar+0.6, \mthree) {$+66\%$};
...
\node[font=\small, black!40, anchor=west] at (\chartx+\maxbar+0.6, \mfour) {matched};
...
\node[font=\small, black!40, anchor=west] at (\chartx+\maxbar+0.6, \mfive) {matched};

% Legend
\fill[CornellRed!70] (\chartx+0.5, \charty-4.6) rectangle (\chartx+1.0, \charty-4.35);
\draw[thick, CornellRed!90!black] (\chartx+0.5, \charty-4.6) rectangle (\chartx+1.0, \charty-4.35);
\node[font=\small\bfseries, anchor=west] at (\chartx+1.1, \charty-4.475) {SA ($\beta{=}8$, ours)};

\fill[white] (\chartx+4.3, \charty-4.6) rectangle (\chartx+4.8, \charty-4.35);
\draw[thick, black!40] (\chartx+4.3, \charty-4.6) rectangle (\chartx+4.8, \charty-4.35);
\node[font=\small, black!60, anchor=west] at (\chartx+4.9, \charty-4.475) {VAE (latent${=}8$)};
