...
% -----------------------------------------------------------
Does SA still work when we scale to high-dimensional image data, and does the $\beta^*\!\sim\!\sqrt{N}$ rule remain a reliable guide for temperature selection?
...
\vspace{4pt}
\qrcode[height=6cm]{https://github.com/varnerlab/stochastic-attention-study-paper}
